...
public class IssueController {
     ...
     * @return ResponseEntity containing a list of candidates and their effectiveness scores
     */
    @GetMapping("/issues/{issueName}/candidates")
    public ResponseEntity<List<Candidate>> getEffectiveCandidates(@PathVariable String issueName) {
        List<Candidate> candidates = issueService.getEffectiveCandidatesForIssue(issueName);
